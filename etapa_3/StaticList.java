...
public class StaticList<E> implements List<E> {
    ...
    private int contaElementosRecursivo(E el, int indice) {		
		// Fim
        ...
        int contagemAtual = elements[indice].equals(el) ? 1 : 0;
        
        // Chamada recursiva para o próximo elemento
        return contagemAtual + contaElementosRecursivo(el, indice + 1);
    }
}